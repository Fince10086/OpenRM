...
用途:
  本脚本为 Narrator 插件生成 ORMNarrator.icns (macOS) 与 ORMBandPass.ico (Windows)。
...
# ---- PLUGIN 段: 做新插件时改这里 ----
ICON_NAME = "ORMNarrator"    # 输出文件名 (icns/ico 均用此名, 与 iPlug2 自动发现规则一致)
TEXT_TOP = "ORM"             # 第一行
TEXT_BOTTOM = "Narrator"     # 第二行
# -----------------------------------
