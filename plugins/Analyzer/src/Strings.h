  ...
  static const char *const kTable[kNumLanguages][kNumTexts] = {
      {
          ...
          "Switch analysis engine (STFT / VQT / PAZ / MR-FFT)",
          "AUDIO",
          "Input",
          "Output",
          "Driver",
          ...
          "Window mode (STFT/VQT): SHARP (Hann: sharp mainlobe, classic response) / CLEAN (4-term Blackman-Harris: -92 dB ultra-low leakage)",
      },
      {
          "释放",
          "范围",
          ...
          "窗函数模式（STFT/VQT）：SHARP（Hann: 锐利窄主瓣，经典响应）/ CLEAN（4阶 Blackman-Harris: -92 dB 极低旁瓣泄露）",
      },
  };
