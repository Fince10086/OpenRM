...
inline const char* const kAl2Labels[64] = {
  "PA1", "PA2", "PA3", "PA4", "PA5", "OY", "AY", "EH", "KK3", "PP", "JH", "NN1", "IH", "TT2", "RR1", "AX", "MM", "TT1", "DH1", "IY", "EY", "DD1", "UW1", "AO", "AA", "YY2", "AE", "HH1", "BB1", "TH", "UH", "UW2", "AW", "DD2", "GG3", "VV", "GG1", "SH", "ZH", "RR2", "FF", "KK2", "KK1", "ZZ", "NG", "LL", "WW", "XR", "WH", "YY1", "CH", "ER1", "ER2", "OW", "DH2", "SS", "NN2", "HH2", "OR", "AR", "YR", "GG2", "EL", "BB2"
};

inline const char* const k012Labels[43] = {
  "(SPB640 Speech FIFO)", "pause4", "pause3", "pause2", "pause1", "pause0", "Mattel Electronics Presents", "Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen", "Seventeen", "Eighteen", "Nineteen", "Twenty", "Thirty", "Fourty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety", "Hundred", "Thousand", "-teen", "-ty", "Press", "Enter", "Or", "And"
};

inline const unsigned char kRomAl2[4096] = {
...
inline const unsigned char kRom012[4096] = {
...
// 版本顺序 = kSp0256Voice 参数枚举 (0=AL2 1=012)
inline const Variant kVariants[2] = {
  {"AL2", kAl2Labels, 64, kRomAl2},
  {"012", k012Labels, 43, kRom012},
};
inline constexpr int kNumVariants = 2;
